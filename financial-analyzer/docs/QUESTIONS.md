...
| **Q66** | **Méthode de dépendance** pour les bornes de rareté : bootstrap par blocs, condition de mélange, ou équivalent, avec son argument et son paramètre. Sans elle, « 0 survivant sur N épisodes » reste une observation et aucune exclusion par fréquence n'est prononçable (ADR-209). | 🔴 | Q51-A add.4 §1 |
| **Q67** | **Borne physique du gain `S_U`** par cellule et horizon — déplacement maximal qu'un survivant pourrait capturer. Permet de conclure sur la capacité économique sans observer de survivant (ADR-211). Dérivable de l'export Q50. | 🟠 | Q51-A add.4 §3 |
